...
public class Sku implements Serializable {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		description = "External reference code of the catalog currency. Resolved before `catalogCurrencyCode` and, when the currency has not been imported yet, used to create it as an empty stub.",
		example = "US_DOLLAR"
	)
	...
	public String getProductTypeName() {
		if (_productTypeNameSupplier != null) {
			productTypeName = _productTypeNameSupplier.get();

			_productTypeNameSupplier = null;
		}
	...
	public void setProductTypeName(
		...
		_productTypeNameSupplier = () -> {
			try {
				return productTypeNameUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@JsonIgnore
	private Supplier<String> _productTypeNameSupplier;
	...
	public String toString() {
		...
		if (productTypeName != null) {
			...
			sb.append(_escape(productTypeName));
...
// LIFERAY-REST-BUILDER-HASH:1521254753