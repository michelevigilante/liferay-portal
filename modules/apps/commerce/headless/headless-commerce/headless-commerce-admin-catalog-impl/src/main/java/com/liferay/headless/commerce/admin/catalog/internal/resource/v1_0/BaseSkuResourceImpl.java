...
public abstract class BaseSkuResourceImpl
	...
	public Sku patchSkuByExternalReferenceCode(
		...
		if (sku.getProductTypeName() != null) {
			existingSku.setProductTypeName(sku.getProductTypeName());
		}
...
// LIFERAY-REST-BUILDER-HASH:1553077063