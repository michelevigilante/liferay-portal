...
public abstract class BaseSkuResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		Assert.assertEquals(regex, sku.getProductTypeName());
		Assert.assertEquals(
	...
	protected void assertValid(Sku sku) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("productTypeName", additionalAssertFieldName)) {
	...
	protected boolean equals(Sku sku1, Sku sku2) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("productTypeName", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						sku1.getProductTypeName(), sku2.getProductTypeName())) {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("productTypeName")) {
			Object object = sku.getProductTypeName();
		...
		return new Sku() {
			{
				...
				productTypeName = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
...
// LIFERAY-REST-BUILDER-HASH:-1243816900