...
public class SkuSerDes {
	...
	public static String toJSON(Sku sku) {
		...
		if (sku.getProductTypeName() != null) {
			...
			sb.append(_escape(sku.getProductTypeName()));
	...
	public static Map<String, String> toMap(Sku sku) {
		...
		if (sku.getProductTypeName() == null) {
			...
			map.put(
				"productTypeName", String.valueOf(sku.getProductTypeName()));
		}
	...
	public static class SkuJSONParser extends BaseJSONParser<Sku> {
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "productTypeName")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "catalogCurrencyCode")) {
				...
				if (jsonParserFieldValue != null) {
					sku.setProductTypeName((String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "promoPrice")) {
				if (jsonParserFieldValue != null) {
...
// LIFERAY-REST-BUILDER-HASH:1477966602